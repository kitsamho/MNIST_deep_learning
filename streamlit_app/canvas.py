...
# custom dependencies
from streamlit_app.model_inference.load_model import load_model, get_inference_transformer
from streamlit_app.model_inference.images import load_image_from_canvas
...
def write():
    st.title('Doodle Inference Pad')
    st.write('Draw a digit between 0 and 9 and see if the model recognises it.')
